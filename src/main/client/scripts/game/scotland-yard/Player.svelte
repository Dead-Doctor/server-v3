<script lang="ts">
    ...
    import { playerType, type PlayerType, type Point } from "./scotland-yard";
    ...
    let scale = $derived(size / (halfSize * 2));
...
<g
    ...
    <path
        class:misterX={type === playerType.MISTER_X}
        class:detective1={type === playerType.DETECTIVE1}
        class:detective2={type === playerType.DETECTIVE2}
        class:detective3={type === playerType.DETECTIVE3}
        class:detective4={type === playerType.DETECTIVE4}
        class:detective5={type === playerType.DETECTIVE5}
        class:detective6={type === playerType.DETECTIVE6}
