...
object Page {
    ...
    class Layout(private val account: Account, private val uri: String, private val title: String): Template<HTML> {
        ...
        override fun HTML.apply() {
            ...
            body {
                header {
                    nav {
                        a(classes = "branding action", href = "/") {
    ...
    fun FlowOrPhrasingContent.icon(name: String) {
